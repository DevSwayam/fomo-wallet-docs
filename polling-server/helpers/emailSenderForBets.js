...
import { readAndSendHint } from "./ReadAndSendHint.js";
import { callUserApi } from "./callUserAPI.js";
...
export async function callApiForPlacedBets(bet) {
  try {
    console.log(bet);
    ...
    const {
      scaledUserBettedAmount: userBettedValue,
      scaledSecretNumber: actualValue,
    } = await readAndSendHint(betId, amount);
